...
private:
	...
	static int CallInspMatchingExample(void* lpUserData);
	static int CallInspMatching(void* lpUserData);
	static int CallInspMatchingWally(void* lpUserData);
	static int CallInspMatchingZoom(void* lpUserData);

	int OnInspMatchingExample();
	int OnInspMatching();
	int OnInspMatchingWally();
	int OnInspMatchingZoom();
